...
<?php
    ...
    $theme_value = $wpdb->get_row("SELECT setting_value FROM $settings_table WHERE id = 2");
    $animation_value = $wpdb->get_row("SELECT setting_value FROM $settings_table WHERE id = 3");
    $animation_speed_value = $wpdb->get_row("SELECT setting_value FROM $settings_table WHERE id = 4");
    $alignment_value = $wpdb->get_row("SELECT setting_value FROM $settings_table WHERE id = 5");
    $mode_value = $wpdb->get_row("SELECT setting_value FROM $settings_table WHERE id = 6");
